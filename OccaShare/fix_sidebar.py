...
html_content = re.sub(r'<!-- Right: Sidebar -->[\s\S]*?(?=<!-- Add Schedule Modal -->|<!-- Modal: Event Details -->|<!-- Calendar Event Details Modal -->|<!-- Blocked Date Modal -->|<script)', new_sidebar + '\n', html_content)

# Fix CSS version for cache busting
html_content = re.sub(r'v=12\.6', 'v=12.7', html_content)

with open('templates/caterer/calendar.html', 'w', encoding='utf-8') as f:
    f.write(html_content)

print("Fixed Sidebar Replacement")
